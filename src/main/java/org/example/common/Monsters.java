...
public class Monsters {
    ...
    /*
        ...
        in an integer array speed of size n, where speed[i] is the speed of the ith monster in kilometers
        per minute.
        ...
        the weapon is fully charged, it counts as a loss, and the game ends before you can use
        your weapon.
